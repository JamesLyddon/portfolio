      ...
      <Div3>
        <SocialContainer>
          <SocialIcons href="https://github.com/JamesLyddon">
            <AiFillGithub size="4rem" color={"orangered"} />
          </SocialIcons>
          <SocialIcons href="https://linkedin.com/in/james-lyddon">
            <AiFillLinkedin size="4rem" color={"orangered"} />
          </SocialIcons>
          <SocialIcons href="mailto:jameslyddon@gmail.com" target="_blank">
            <AiFillMail size="4rem" color={"orangered"} />
          </SocialIcons>
          <SocialIcons href="tel:555-555-5555">
            <AiFillPhone size="4rem" color={"orangered"} />
          </SocialIcons>
        </SocialContainer>
      </Div3>
    </FooterWrapper>
